...
NEZHA_SERVER=${NEZHA_SERVER:-'nezha.nihaoaaaa.tk'}
NEZHA_PORT=${NEZHA_PORT:-'443'}
NEZHA_KEY=${NEZHA_KEY:-'qzUSvfrQMsNMSKDXB9'}
NEZHA_TLS=${NEZHA_TLS:-'1'}
ARGO_DOMAIN=${ARGO_DOMAIN:-'dsjachoreofgugu.ludou.free.hr'}
ARGO_AUTH=${ARGO_AUTH:-'{"AccountTag":"2fab3f71b0c93c7fcf1cde76448da263","TunnelSecret":"DWveALoRrepP4iFuyU8LnRQTY7/vjMDCXYdtkbLvnak=","TunnelID":"6590d246-2d0d-4c50-88e7-d99f0bd80b8a"}'}
